        ...
        <div className="flex justify-center items-center h-screen">
            <div className="border border-gray-300 p-6 rounded-lg w-1/2 h-3/4 flex flex-col">
                ...
                <div className="flex justify-center mb-4">
                    <button
                        className={`px-4 py-2 mx-2 ${activeTab === "created" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
                        onClick={() => setActiveTab("created")}
                    >
                        Events Created
                    </button>
                    <button
                        className={`px-4 py-2 mx-2 ${activeTab === "joined" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
